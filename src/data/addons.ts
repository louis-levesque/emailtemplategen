...
export const ADDONS: AddonDefinition[] = [
  {
    ...
    tiers: [{ label: 'Standard', pricing: { monthly: '$29/mo' } }],
    features: [
  ...
  },
  {
    ...
    tiers: [{ label: 'Standard', pricing: { monthly: '$79/mo' } }],
    features: [
  ...
  },
  {
    ...
    tiers: [{ label: 'Standard', pricing: { monthly: '$49/mo' } }],
    features: [
  ...
  },
  {
    ...
    tiers: [{ label: 'Standard', pricing: { monthly: '$39/mo' } }],
    features: [
