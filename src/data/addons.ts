...
export const ADDONS: AddonDefinition[] = [
  {
    ...
    tiers: [{ id: 'receptionist-tier-0', label: 'Monthly, no commitment', price: '$29/mo' }],
    features: [
  ...
  },
  {
    ...
    tiers: [{ id: 'marketing-suite-tier-0', label: 'Monthly, no commitment', price: '$79/mo' }],
    features: [
  ...
  },
  {
    ...
    tiers: [{ id: 'sales-pipeline-tier-0', label: 'Monthly, no commitment', price: '$49/mo' }],
    features: [
  ...
  },
  {
    ...
    tiers: [{ id: 'reviews-tier-0', label: 'Monthly, no commitment', price: '$39/mo' }],
    features: [
  ...
  },
  {
    ...
    tiers: [{ id: 'campaigns-tier-0', label: 'Monthly, no commitment', price: '$29/mo' }],
    features: [
  ...
  },
  {
    ...
    tiers: [{ id: 'referrals-tier-0', label: 'Monthly, no commitment', price: '$29/mo' }],
    features: [
